# BubbleWatch Daily Digest — 2026-09-24 05:56 UTC
...
| Indicator | Value |
|---|---|
| Bubble temperature (0-100) | 61.60 |
| Gauge coverage | 0.80 |
...
| Power/utilities theme momentum 60d | -0.12 |
...
|---|---|---|---|
| equities | ok | 24706 | total=25444 new_days=1 src=yfinance |
...
|:------------------|:-----------|----:|--------:|-----------:|
| AI_complex_dir_5d | p_model    |  31 |   0.274 |      0.323 |
| AI_complex_dir_5d | p_constant |  31 |   0.25  |      0.323 |
