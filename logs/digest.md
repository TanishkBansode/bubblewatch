# BubbleWatch Daily Digest — 2026-09-20 05:52 UTC

## Verdict
- **Bubble temperature:** **51/100** (warm) — gauge coverage 80%
...
| Indicator | Value |
|---|---|
| Bubble temperature (0-100) | 50.90 |
| Gauge coverage | 0.80 |
| AI complex momentum 20d | 0.02 |
| AI complex momentum 60d | 0.12 |
| Drawdown from 250d high | -0.00 |
| AI complex vs SPY 60d excess | 0.10 |
| AI complex vs equal-weight S&P 60d | 0.12 |
| Cap-vs-equal-weight spread 60d (concentration) | 0.02 |
| Power/utilities theme momentum 60d | -0.14 |
...
|---|---|---|---|
| equities | ok | 24720 | total=25358 new_days=1 src=yfinance |
...
|:------------------|:-----------|----:|--------:|-----------:|
| AI_complex_dir_5d | p_model    |  27 |  0.2707 |       0.37 |
| AI_complex_dir_5d | p_constant |  27 |  0.25   |       0.37 |
