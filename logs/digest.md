# BubbleWatch Daily Digest — 2026-08-29 07:44 UTC

## Verdict
- **Bubble temperature:** **48/100** (warm) — gauge coverage 80%
- **Regime:** `expansion` — uptrend intact without froth extremes
- **Model** P(AI complex up next 5d): **46%** (test Brier 0.2981 vs majority acc 0.655, asof 2026-08-25)

## Key indicators
| Indicator | Value |
|---|---|
| Bubble temperature (0-100) | 48.40 |
| Gauge coverage | 0.80 |
| AI complex momentum 20d | 0.03 |
| AI complex momentum 60d | 0.08 |
| Drawdown from 250d high | -0.01 |
| AI complex vs SPY 60d excess | 0.05 |
| AI complex vs equal-weight S&P 60d | 0.05 |
| Cap-vs-equal-weight spread 60d (concentration) | -0.01 |
| Power/utilities theme momentum 60d | -0.06 |
| BTC momentum 30d (risk appetite) | 0.20 |
...
|---|---|---|---|
| equities | ok | 24688 | total=24856 new_days=1 src=yfinance |
...
|:------------------|:-----------|----:|--------:|-----------:|
| AI_complex_dir_5d | p_model    |   5 |  0.3402 |          0 |
| AI_complex_dir_5d | p_constant |   5 |  0.25   |          0 |
