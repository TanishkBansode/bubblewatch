# BubbleWatch Daily Digest — 2026-09-15 05:57 UTC

## Verdict
- **Bubble temperature:** **59/100** (warm) — gauge coverage 80%
...
|---|---|---|---|
| equities | ok | 24720 | total=25225 new_days=1 src=yfinance |
...
|:------------------|:-----------|----:|--------:|-----------:|
| AI_complex_dir_5d | p_model    |  22 |   0.269 |      0.409 |
| AI_complex_dir_5d | p_constant |  22 |   0.25  |      0.409 |
