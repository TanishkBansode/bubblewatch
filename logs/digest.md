# BubbleWatch Daily Digest — 2026-08-28 12:35 UTC

## Verdict
- **Bubble temperature:** **52/100** (warm) — gauge coverage 80%
- **Regime:** `expansion` — uptrend intact without froth extremes
- **Model** P(AI complex up next 5d): **46%** (test Brier 0.2979 vs majority acc 0.648, asof 2026-08-25)

## Key indicators
| Indicator | Value |
|---|---|
| Bubble temperature (0-100) | 52.30 |
| Gauge coverage | 0.80 |
...
|---|---|---|---|
| equities | ok | 24720 | total=24855 new_days=1 src=yfinance |
...
|:------------------|:-----------|----:|--------:|-----------:|
| AI_complex_dir_5d | p_model    |   4 |  0.3505 |          0 |
| AI_complex_dir_5d | p_constant |   4 |  0.25   |          0 |
