# BubbleWatch Daily Digest — 2026-09-07 05:49 UTC

## Verdict
- **Bubble temperature:** **50/100** (warm) — gauge coverage 80%
...
| Indicator | Value |
|---|---|
| Bubble temperature (0-100) | 49.70 |
| Gauge coverage | 0.80 |
...
|---|---|---|---|
| equities | ok | 24720 | total=25056 new_days=1 src=yfinance |
...
|:------------------|:-----------|----:|--------:|-----------:|
| AI_complex_dir_5d | p_model    |  14 |  0.2976 |      0.143 |
| AI_complex_dir_5d | p_constant |  14 |  0.25   |      0.143 |
