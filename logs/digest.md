# BubbleWatch Daily Digest — 2026-09-08 05:42 UTC

## Verdict
- **Bubble temperature:** **49/100** (warm) — gauge coverage 80%
...
| Indicator | Value |
|---|---|
| Bubble temperature (0-100) | 49.30 |
| Gauge coverage | 0.80 |
...
|---|---|---|---|
| equities | ok | 24720 | total=25058 new_days=1 src=yfinance |
...
|:------------------|:-----------|----:|--------:|-----------:|
| AI_complex_dir_5d | p_model    |  15 |  0.2975 |      0.133 |
| AI_complex_dir_5d | p_constant |  15 |  0.25   |      0.133 |
