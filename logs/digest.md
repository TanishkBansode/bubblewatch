# BubbleWatch Daily Digest — 2026-09-17 05:53 UTC
...
| Indicator | Value |
|---|---|
| Bubble temperature (0-100) | 58.70 |
| Gauge coverage | 0.80 |
...
| BTC momentum 30d (risk appetite) | 0.18 |
...
|---|---|---|---|
| equities | ok | 24720 | total=25291 new_days=1 src=yfinance |
...
|:------------------|:-----------|----:|--------:|-----------:|
| AI_complex_dir_5d | p_model    |  24 |  0.2639 |      0.458 |
| AI_complex_dir_5d | p_constant |  24 |  0.25   |      0.458 |
